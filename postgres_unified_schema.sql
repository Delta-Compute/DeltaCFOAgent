...
CREATE TRIGGER update_investor_relationships_updated_at BEFORE UPDATE ON investor_relationships
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
BEGIN
    ...
    RAISE NOTICE '- Business Intelligence: investor_relationships, investments, vendor_profiles, vendor_interactions';
    RAISE NOTICE '- Business Rules: business_rules, rule_conditions, rule_actions';
    ...
    RAISE NOTICE 'Business Intelligence: Investor and vendor relationship tracking';
    RAISE NOTICE 'Dynamic Rules: Database-driven business logic configuration';
    RAISE NOTICE '';
